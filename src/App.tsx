...
const App = () => {
    ...
    const checkFoodRandom = foods[Math.floor(Math.random() * nextFood.length + 1)];
    ...
    return (
        <>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '40px', color: 'purple' }}>오늘 뭐 먹을래?</div>
            <Rayout>
                <Main>
                ...
                <div>
                    <ResultFoodBox>
                        ...
                        {foodRandomIsOpen === true ? foodRandom.name : null}
                    </ResultFoodBox>
                </div>
                <div>
                    <div>선택한 메뉴만 고르기</div>
                    <Button variant="outlined" style={{ width: '150px', height: '50px' }}>
                        돌리기
                    </Button>
                    <div>
